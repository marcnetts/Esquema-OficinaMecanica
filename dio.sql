CREATE SCHEMA IF NOT EXISTS `diodb2` DEFAULT CHARACTER SET utf8 ;
USE `diodb2` ;

CREATE TABLE IF NOT EXISTS `diodb2`.`cliente` (
...
CREATE TABLE IF NOT EXISTS `diodb2`.`especialidade` (
...
CREATE TABLE IF NOT EXISTS `diodb2`.`mecanico` (
  ...
  CONSTRAINT `fk_mecanico_especialidade1`
    ...
    REFERENCES `diodb2`.`especialidade` (`id_especialidade`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;

CREATE TABLE IF NOT EXISTS `diodb2`.`veiculo` (
  ...
  CONSTRAINT `fk_veiculo_cliente`
    ...
    REFERENCES `diodb2`.`cliente` (`id_cliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;

CREATE TABLE IF NOT EXISTS `diodb2`.`ordemservico` (
  ...
  CONSTRAINT `fk_ordemservico_veiculo1`
    ...
    REFERENCES `diodb2`.`veiculo` (`id_veiculo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;

CREATE TABLE IF NOT EXISTS `diodb2`.`peca` (
...
CREATE TABLE IF NOT EXISTS `diodb2`.`tipo_servico` (
...
CREATE TABLE IF NOT EXISTS `diodb2`.`peca_has_ordemservico` (
  ...
  CONSTRAINT `fk_peca_has_ordemservico_peca1`
    ...
    REFERENCES `diodb2`.`peca` (`id_peca`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_peca_has_ordemservico_ordemservico1`
    FOREIGN KEY (`id_ordemservico`)
    REFERENCES `diodb2`.`ordemservico` (`id_ordemservico`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;

CREATE TABLE IF NOT EXISTS `diodb2`.`ordemservico_has_tipo_servico` (
  `id_ordemservico` INT(11) NOT NULL,
  `id_servico` INT(11) NOT NULL,
  ...
  CONSTRAINT `fk_ordemservico_has_tipo_servico_tipo_servico1`
    ...
    REFERENCES `diodb2`.`tipo_servico` (`id_servico`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;

CREATE TABLE IF NOT EXISTS `diodb2`.`ordemservico_has_mecanico` (
  `id_ordemservico` INT(11) NOT NULL,
  ...
  CONSTRAINT `fk_ordemservico_has_mecanico_mecanico1`
    ...
    REFERENCES `diodb2`.`mecanico` (`id_mecanico`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
